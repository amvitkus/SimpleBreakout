...
public class Board extends JPanel implements Commons {
	...
	public void paint(Graphics g){
		...
		if (ingame){
			g.drawImage(ball.getImage(), ball.getX(), ball.getY(), ball.getWidth(), ball.getHeigth(), this);
			g.drawImage(paddle.getImage(), paddle.getX(), paddle.getY(), paddle.getWidth(), paddle.getHeigth(), this);
